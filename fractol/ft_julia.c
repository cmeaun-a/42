...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/02/17 14:02:31 by cmeaun-a          #+#    #+#             */
/*   Updated: 2017/03/01 18:11:49 by cmeaun-a         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fractol.h"

void	ft_suite(t_env *e, int *i)
{
...
void	ft_tricorn5_cal(t_env *e, int *i)
{
	while (e->z_r * e->z_r + e->z_i * e->z_i < 4 && *i < e->iteration_max)
	{
		...
		e->z_i = -5 * e->z_r * e->z_r * e->z_r * e->z_r * e->z_i - -10 *
			e->z_r * e->z_r * e->z_i * e->z_i * e->z_i + -1 * e->z_i *
